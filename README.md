...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create class-manager-5274
  fly apps create class-manager-5274-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app class-manager-5274
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app class-manager-5274-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'class-manager-5274-staging' does not match app name in config file 'class-manager-5274'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name class-manager-5274-db
  fly postgres attach --app class-manager-5274 class-manager-5274-db

  fly postgres create --name class-manager-5274-staging-db
  fly postgres attach --app class-manager-5274-staging class-manager-5274-staging-db
  ```
